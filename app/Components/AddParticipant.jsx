    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter details of the participant. Click Add when you're done.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              onChange={(e) => setParticipantDetails({ ...participantDetails, name: e.target.value })}
            />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              className="col-span-3"
              onChange={(e) => setParticipantDetails({ ...participantDetails, school: e.target.value })}
            />
          </div>
        </div>
        <DialogFooter>
          <Button type="submit" onClick={handleAddParticipant}>Add</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )
